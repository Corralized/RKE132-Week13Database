...
{
SQLiteConnection connection = new SQLiteConnection("Data Source=mydb.db; Version = 3; Ner=True; Compress = True;");
...
static void RemoveCustomer(SQLiteConnection myConnection)
{
    ...
    Console.WriteLine($"{rowRemoved} was removed from customer list.");
